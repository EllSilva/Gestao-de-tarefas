...
import page_projecto_detalhes from './view/projecto/projecto-detalhes.js'
Vue.component('p-projecto-detalhes', page_projecto_detalhes) 
...
const routes = [
    ...
    { path: '/projecto/detalhe', component: { template: '<p-projecto-detalhes></p-projecto-detalhes>' } },
